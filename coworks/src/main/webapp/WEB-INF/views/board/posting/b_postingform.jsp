            ...
            <div class="card-body">
              ...
              <form action="/board/posting" method="post" id="frm">
              	<div class="row mb-3">
              		...
              		<div class="col-sm-5">
              			<div class="dropdown">
		              		<button type="button" class="btn btn-success dropdown-toggle" data-bs-toggle="dropdown" id="board-dropdown" data-bs-target="dropdown" aria-expanded="false">
		              			게시판 선택
		              		</button>
							  <ul class="dropdown-menu" aria-labelledby="board-dropdown" id="board-select">
								 <c:forEach var="board" items="${boardDTO.list}" varStatus="status">
									<li value="${board.board_number }"><a class="dropdown-item" href="#" >${board.board_name }</a></li>
								</c:forEach>
							  </ul>
              						<input type="hidden" name="board_number" id="board-no" value="">
						</div>
              	   </div>
              </div>
