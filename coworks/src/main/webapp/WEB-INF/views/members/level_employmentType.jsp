        ...
        <main>
            <main>
                <div class="container-fluid px-4">
                    ...
                    <button type="button" class="btn btn-outline-primary" style="float:right" onclick="location.href='level-employment-type-update'">수정</button>
...
<%--                            <c:if test="${level.employmentType != null}">--%>
<%--                                <tr>--%>
<%--                                    <td>${count}</td>--%>
<%--                                    <c:set var="count" value="${count + 1}"/>--%>
<%--                                    <td>${level.employmentType}</td>--%>
<%--                                </tr>--%>
<%--                            </c:if>--%>
<%--                        </c:forEach>--%>
                        <c:forEach begin="1" end="${size}" step="1" var="i">
                            <c:if test="${level.levelList[i].employmentType != null}">
                                <tr>
                                    <td>${count}</td>
                                    <c:set var="count" value="${count + 1}"/>
                                    <td>${level.levelList[i].employmentType}</td>
                                </tr>
                            </c:if>
                        </c:forEach>
                        </tbody>
