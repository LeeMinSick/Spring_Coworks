            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item disabled"><a href="employmentType">직급</a></li>
                        <li class="breadcrumb-item"><a href="employment-type">고용형태</a></li>
                    </ol>
                    <%--tables--%>
                    <table class="table table-striped table-hover" id="table">
                        ...
                        <c:forEach begin="1" end="${size}" step="1" var="i">
                            <c:if test="${level.levelList[i].employmentType != null}">
                                <tr>
                                    <td>
                                        <div>${count}</div>
                                    ...
                                    <td><input type="text" style="background:transparent; height:35px;"
                                               value="${level.levelList[i].employmentType}"/></td>
                                    <td>
                        ...
                        <script>
                            ...
                            function update() {
                                ...
                                for (var i = 0; i < $('#table tbody tr').length; i++) {
                                    ...
                                    var employmentType = $('#table tbody tr').eq(i).children().eq(1).children().val();
                                    console.log("levelId : " + levelId);
                                    dataObj.levelId = levelId;
                                    dataObj.employmentType = employmentType;
                                ...
                                $.ajax({
                                    contentType: 'application/json',
                                    type: "POST",
                                    url: 'level-employment-type-update-json',
                                    dataType: 'json',
                                    data: jsonData,
                                    success: function (result) {
                                        alert("수정 완료");
                                        location.href="employment-type";
                                    },
                                    error: function (er) {
                                        console.log(er);
                                    }
