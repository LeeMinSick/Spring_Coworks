        ...
        <main>
            <main>
                <div class="container-fluid px-4">
                    ...
                    <button type="button" class="btn btn-outline-primary" style="float:right" onclick="location.href='level-rank-update'">수정</button>
