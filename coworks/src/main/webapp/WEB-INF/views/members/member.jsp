                        ...
                        <div class="sb-sidenav-menu">
                            <c:forEach begin="0" end="${size}" step="1" var="i">
                                <c:if test="${department.departmentList[i].parentDepNum == 0}">
                                    <div class="nav" id="depart${department.departmentList[i].departmentNumber}">
                                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                                           ...
                                           aria-controls="dep${department.departmentList[i].departmentNumber}">
                                            <i class="fas fa-angle-down" style="margin-right:3px"></i>
                                                ${department.departmentList[i].departmentName}
                                        </a>
                                    </div>
                                ...
                                <c:if test="${department.departmentList[i].parentDepNum != 0}">
                                    <script>child('${department.departmentList[i].parentDepNum}', '${department.departmentList[i].departmentName}')</script>
                                </c:if>
                            </c:forEach>
                        </div>
                    </nav>
                ...
                <div class="layoutSidenav_content">
                    <main>
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">구성원</h1>
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                <li class="breadcrumb-item disabled"><a href="index.html">직급</a></li>
                                <li class="breadcrumb-item disabled"><a href="index.html">고용형태</a></li>
                            </ol>
                            <%--tables--%>
                            <table class="table table-striped table-hover">
                                ...
                                <c:forEach var="member" items="${listMember}">
                                    <form:form action="member-detail" method="post">
                                        <tr>
                                            <input type="hidden" name="membershipNumber"
